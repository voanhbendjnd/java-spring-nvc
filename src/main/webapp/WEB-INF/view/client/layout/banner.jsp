            ...
            <div class="container py-5">
                <div class="row g-5 align-items-center">
                    <div class="col-md-12 col-lg-7">
                        <h4 class="mb-3 text-secondary">Bảo hành 2 năm </h4>
                        <h1 class="mb-5 display-3 text-primary">Laptop cùng với deal siêu hời</h1>
                            ...
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item active rounded">
                                    ...
                                    <a href="#" class="btn px-4 py-2 text-white rounded"
                                        style="font-family: 'Times New Roman', Times, serif;">Laptop</a>
                                </div>
                                <div class="carousel-item rounded">
                                    <img src="/client/img/hero-img-2.png" class="img-fluid w-100 h-100 rounded"
                                        alt="Second slide">
                                    <a href="#" class="btn px-4 py-2 text-white rounded"
                                        style="font-family: 'Times New Roman', Times, serif;">Phụ kiện chính hãng</a>
                                </div>
                            </div>
